...
| Z.130.0    | Basic layer 1 functions: L1 **S**DI, R**A**I, **R**eset, **L**OS, LO**F**. Format: "rrrF LSAR", where b0: **R**eset, b1: R**A**I, b2: **S**DI, b3: **L**OS, b4: LO**F**, b7-b5: reserved |
| Z.194.0    | **P**ointer p, which indicates the subchannel number **N***s* at which the control words for the Ethernet channel starts within a hyperframe. Format: "rrPPPP PP", where b5-b0: **P**ointer to subchannel number, b7-b6: reserved |
