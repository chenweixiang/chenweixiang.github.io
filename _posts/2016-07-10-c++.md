...
The **ISO/IEC 14882:1998** was withdrawn and was revised by **ISO/IEC 14882:2003**. The **ISO/IEC 14882:1998** is [no longer available from ISO](http://www.iso.org/iso/home/store/catalogue_tc/catalogue_detail.htm?csnumber=25845).
...
The [**ISO/IEC 14882:2003**](/docs/ISO-IEC_14882-2003_2003-10-15.pdf) was withdrawn and was revised by **ISO/IEC 14882:2011**. The **ISO/IEC 14882:2003** is [no longer available from ISO](http://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=38110).

[FAQ: What is the difference between C++98 and C++03?](https://isocpp.org/wiki/faq/big-picture#cpp98-to-cpp03)
...
In 2011, a major revision of the standard was informally referred to as **C++0x**, but it was not released until 2011. The **ISO/IEC 14882:2011** included most of the library enhancements of **C++07/TR1**, as well as many additions to the core language.

The **ISO/IEC 14882:2011** was withdrawn and was revised by **ISO/IEC 14882:2014**. The **ISO/IEC 14882:2011** is [no longer available from ISO](http://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=50372). A free C++11 Working Draft [N3337 in PDF format](/docs/ISO-IEC_14882-2011_Committee_Draft_N3337_2012-01-16.pdf) or [N3337 in HTML format on GitHub](https://timsong-cpp.github.io/cppwp/n3337/) is available. The [differences](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2012/n3338.html) between the Working Draft and the C++11 Standard are minor.
...
[FAQ: What is the difference between C++98 and C++11?](https://isocpp.org/wiki/faq/big-picture#cpp98-to-cpp11)

See [what’s new in C++11](https://isocpp.org/wiki/faq/cpp11) and C++11 Language Extensions [General Features](https://isocpp.org/wiki/faq/cpp11-language), [Classes](https://isocpp.org/wiki/faq/cpp11-language-classes), [Other Types](https://isocpp.org/wiki/faq/cpp11-language-types), [Templates](https://isocpp.org/wiki/faq/cpp11-language-templates), [Concurrency](https://isocpp.org/wiki/faq/cpp11-language-concurrency), [Miscellaneous Language Features](https://isocpp.org/wiki/faq/cpp11-language-misc) and C++11 Library Extensions [General Libraries](https://isocpp.org/wiki/faq/cpp11-library), [Containers and Algorithms](https://isocpp.org/wiki/faq/cpp11-library-stl), [Concurrency](https://isocpp.org/wiki/faq/cpp11-library-concurrency). C++11 is a major upgrade over C++98/C++03, with performance and convenience features that make it feel like a new language. Note that the C++ language will remain stable because compatibility is always a major concern. The committee tries hard not to break your (standard conforming) code. Except for some corner cases you’re unlikely to notice, all valid C++98 code is valid C++11 and C++14 code.

## ISO/IEC 14882:2014 (C++14)

In 2014, **ISO/IEC 14882:2014** (**C++14**, also known as **C++1y**) was released as a small extension to **C++11**, featuring mainly bug fixes and small improvements.

A free **ISO/IEC 14882:2014** final draft [N4140 in PDF format](/docs/ISO-IEC_14882-2014_Committee_Draft_N4140_2014-10-07.pdf) or [N4140 in HTML format on GitHub](https://timsong-cpp.github.io/cppwp/n4140/) is available as well as the [differences](https://github.com/cplusplus/draft/compare/n4140...n4141) between it and the standard (N4141).

The **ISO/IEC 14882:2014** was withdrawn and was revised by **ISO/IEC 14882:2017**. The **ISO/IEC 14882:2014** is [no longer available from ISO](https://www.iso.org/standard/64029.html).
...
[FAQ: What is the difference between C++11 and C++14?](https://isocpp.org/wiki/faq/big-picture#cpp11-to-cpp14)

See [what’s new in C++14](https://isocpp.org/wiki/faq/cpp14), [C++14 language additions section](https://isocpp.org/wiki/faq/cpp14-language) and [C++14 library additions section](https://isocpp.org/wiki/faq/cpp14-library). Note that the C++ language will remain stable because compatibility is always a major concern. The committee tries hard not to break your (standard conforming) code. Except for some corner cases you’re unlikely to notice, all valid C++98 code is valid C++14 code.

## ISO/IEC 14882:2017 (C++17)

In 2017, **ISO/IEC 14882:2017** (**C++17**, also known as **C++1z**) was released as a revision to **C++14**.

The final draft of C++17 is [N4659](/docs/ISO-IEC_14882-2017_Committee_Draft_N4659_2017-03-21.pdf) (2017-03-21).
...
Refer to [GCC official site](https://gcc.gnu.org/) and [GCC online documentation](https://gcc.gnu.org/onlinedocs/) for more information.
