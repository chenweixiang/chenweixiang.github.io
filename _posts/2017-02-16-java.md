...
Also refer to the code conventions from [阿里巴巴Java开发手册v1.0.1](/docs/Alibaba_Java_Development_v1.0.1.pdf), [Google Java Style](http://www.hawstein.com/posts/google-java-style.html) and [Google Java Style Guide on GitHub](http://google.github.io/styleguide/javaguide.html).
