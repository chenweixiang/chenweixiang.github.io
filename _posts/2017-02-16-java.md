...
| 2014年8月21日 | Oracle公司发表Java EE 8 |
...
[IBM SDK, Java Technology Edition, Version 8](https://www.ibm.com/support/knowledgecenter/SSYKE2_8.0.0/welcome/welcome_javasdk_version.html) is a new release that is fully compatible with Oracle Java SE version 8 class libraries.
...
C/C++ and Java differ in important ways, as summarized in the following list:
...
Also refer to [Comparison of Java and C++](https://en.wikipedia.org/wiki/Comparison_of_Java_and_C%2B%2B).
...
Also refer to the code conventions from [阿里巴巴Java开发手册v1.0.1](/docs/Alibaba_Java_Development_v1.0.1.pdf), [阿里巴巴Java开发手册v1.2.0](/docs/Alibaba_Java_Development_v1.2.0.pdf), [Google Java Style](http://www.hawstein.com/posts/google-java-style.html) and [Google Java Style Guide on GitHub](http://google.github.io/styleguide/javaguide.html).
